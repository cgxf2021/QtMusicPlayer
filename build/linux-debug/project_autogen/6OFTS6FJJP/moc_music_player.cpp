/****************************************************************************
** Meta object code from reading C++ file 'music_player.hpp'
**
...
#error "The header file 'music_player.hpp' doesn't include <QObject>."
...
static constexpr auto qt_meta_stringdata_CLASSMusicPlayerENDCLASS = QtMocHelpers::stringData(
    "MusicPlayer",
    "songSourceChangedSignal",
    "",
    "playbackModeChanged",
    "MusicPlayer::PlaybackMode",
    "mode",
    "mediaPlayerSourceChanged",
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSMusicPlayerENDCLASS_t qt_meta_stringdata_CLASSMusicPlayerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 23),  // "songSourceChangedSignal"
        QT_MOC_LITERAL(36, 0),  // ""
        QT_MOC_LITERAL(37, 19),  // "playbackModeChanged"
        QT_MOC_LITERAL(57, 25),  // "MusicPlayer::PlaybackMode"
        QT_MOC_LITERAL(83, 4),  // "mode"
        QT_MOC_LITERAL(88, 24),  // "mediaPlayerSourceChanged"
        QT_MOC_LITERAL(113, 25),  // "QMediaPlayer::MediaStatus"
        QT_MOC_LITERAL(139, 6)   // "status"
    },
    "MusicPlayer",
    "songSourceChangedSignal",
    "",
...
Q_CONSTINIT const QMetaObject MusicPlayer::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMusicPlayerENDCLASS_t,
        ...
        // method 'songSourceChangedSignal'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'playbackModeChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<MusicPlayer::PlaybackMode, std::false_type>,
        // method 'mediaPlayerSourceChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void MusicPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->songSourceChangedSignal(); break;
        case 1: _t->playbackModeChanged((*reinterpret_cast< std::add_pointer_t<MusicPlayer::PlaybackMode>>(_a[1]))); break;
        case 2: _t->mediaPlayerSourceChanged((*reinterpret_cast< std::add_pointer_t<QMediaPlayer::MediaStatus>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &MusicPlayer::songSourceChangedSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MusicPlayer::*)(MusicPlayer::PlaybackMode );
            if (_t _q_method = &MusicPlayer::playbackModeChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MusicPlayer::songSourceChangedSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MusicPlayer::playbackModeChanged(MusicPlayer::PlaybackMode _t1)
{
